...
public class RecipeUpdateRequest {
    ...
    @SerializedName("subMenuAppPartID")
    @Expose
    private Integer subMenuAppPartID;
    ...
    public RecipeUpdateRequest(String sessionID, Integer jobID, List<RecipeValue> recipeValue, Integer recipeRefStandardID, Integer recipeRefType) {
        ...
        this.jobID = jobID;
        this.subMenuAppPartID = subMenuAppPartID;
    ...
    public Integer getSubMenuAppPartID() {
        return subMenuAppPartID;
    }

    public void setSubMenuAppPartID(Integer subMenuAppPartID) {
        this.subMenuAppPartID = subMenuAppPartID;
    }
